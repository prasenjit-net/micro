...
var file_test_proto_rawDesc = []byte{
	...
	,
}
...
var file_test_proto_goTypes = []interface{}{
	...
	(*Pong)(nil), // 1: service.Pong
}
var file_test_proto_depIdxs = []int32{
	0, // 0: service.PingPong.ping:input_type -> service.Ping
	1, // 1: service.PingPong.ping:output_type -> service.Pong
...
func (c *pingPongClient) Ping(ctx context.Context, in *Ping, opts ...grpc.CallOption) (*Pong, error) {
	out := new(Pong)
	err := c.cc.Invoke(ctx, "/service.PingPong/ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedPingPongServer) Ping(context.Context, *Ping) (*Pong, error) {
...
func _PingPong_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.PingPong/Ping",
	}
